#!/usr/bin/env python3
"""Verbatim extraction of the python3 heredoc inside bin/generate-packs-json
(PRETTY unset -> compact output). Run from repo root."""
...
if unassigned:
    if not catch_all:
        sys.exit(f"ERROR: {len(unassigned)} skill(s) not assigned to any pack and "
                 ...
                 f"(core|evolution|basics|crypto|productivity) — see docs/skill-packs.md.")
